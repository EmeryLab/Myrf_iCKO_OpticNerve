---
title: "ON_3 Ambient RNA and Doublet Removal - h5 file trial"
...
tod = Seurat::Read10X_h5(here("GEO", "Cell Ranger", "GDMSON_3_raw_feature_bc_matrix.h5")) #Change
toc = Seurat::Read10X_h5(here("GEO", "Cell Ranger", "GDMSON_3_filtered_feature_bc_matrix.h5")) #Change 
sc = SoupChannel(tod,toc)

 
#Make the Seurat object from the filtered control data
SO <- Read10X_h5(here("GEO","Cell Ranger", "GDMSON_3_filtered_feature_bc_matrix.h5")) #Change
...
* Filter (same across all 8 samples)
  + 1,000 `nFeature_RNA` < 4,000 #note this removes half the nuclei
  + `nCount_RNA` < 10,000
...
seurat.obj # Original: 6270
seurat.obj.f # Filtered Nuceli: 3686
...
seurat.obj # Original: 6270
seurat.obj.f # Filtered Nuceli: 3686
seurat.obj.df # Filtered Nuceli: 3712
...
nExp_poi <- round(0.032*nrow(seurat.obj.df@meta.data)) #Change
nExp_poi
...
saveRDS(seurat.obj.df_doublets, here("Outputs", "QC Objects", "Doublet Detector Objects", "DF_GDMS_ON_3.rds")) #Change
```
...
```{r load DF object}
# seurat.obj.df_doublets <- readRDS(here("Outputs", "QC Objects", "Doublet Detector Objects", "DF_GDMS_ON_3.rds")) #Change
```
...
seurat.obj.f <- AddMetaData(object = seurat.obj.f, metadata = "GDMS_ON_3", col.name = "Replicate") #Change
...
seurat.obj.f <- AddMetaData(object = seurat.obj.f, metadata = "G9", col.name = "Animal_1") #Change
seurat.obj.f <- AddMetaData(object = seurat.obj.f, metadata = "G10", col.name = "Animal_2") #Change
...
* Cluster identification
  ...
  + 5 = Unknown
  + 6 = Neurons
  + 7 = Microglia (very low transcripts)
...
saveRDS(seurat.obj.f, here("Outputs", "QC Objects", "QC_GDMS_ON_3.rds")) #Change
```
