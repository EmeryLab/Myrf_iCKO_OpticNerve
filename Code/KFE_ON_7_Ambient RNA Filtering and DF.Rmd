---
title: "ON_7 Ambient RNA and Doublet Removal"
...
tod = Seurat::Read10X_h5(here("GEO", "Cell Ranger", "GDMSON_7_raw_feature_bc_matrix.h5")) #Change
toc = Seurat::Read10X_h5(here("GEO", "Cell Ranger", "GDMSON_7_filtered_feature_bc_matrix.h5")) #Change 
sc = SoupChannel(tod,toc)

 
#Make the Seurat object from the filtered control data
SO <- Read10X_h5(here("GEO", "Cell Ranger", "GDMSON_7_filtered_feature_bc_matrix.h5")) #Change
...
seurat.obj # Original: 54367
seurat.obj.f # Filtered Nuceli: 3869
...
seurat.obj # Original: 54367
seurat.obj.f # Filtered Nuceli: 3869
seurat.obj.df # Filtered Nuceli: 7058
...
nExp_poi <- round(0.056*nrow(seurat.obj.df@meta.data)) #Change
nExp_poi
...
saveRDS(seurat.obj.df_doublets, here("Outputs", "QC Objects", "Doublet Detector Objects", "DF_GDMS_ON_7.rds")) #Change
```
...
```{r load DF object}
# seurat.obj.df_doublets <- readRDS(here("Outputs", "QC Objects", "Doublet Detector Objects", "DF_GDMS_ON_7.rds")) #Change
```
...
seurat.obj.f <- AddMetaData(object = seurat.obj.f, metadata = "GDMS_ON_7", col.name = "Replicate") #Change
seurat.obj.f <- AddMetaData(object = seurat.obj.f, metadata = "Female", col.name = "Sex") #Change
seurat.obj.f <- AddMetaData(object = seurat.obj.f, metadata = "Sox10 WT", col.name = "Genotype") #Change
...
seurat.obj.f <- AddMetaData(object = seurat.obj.f, metadata = "G79", col.name = "Animal_1") #Change
seurat.obj.f <- AddMetaData(object = seurat.obj.f, metadata = "G84", col.name = "Animal_2") #Change
...
saveRDS(seurat.obj.f, here("Outputs", "QC Objects", "QC_GDMS_ON_7.rds")) #Change
```
