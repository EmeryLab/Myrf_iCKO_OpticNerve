---
title: "ON_2 Ambient RNA and Doublet Removal - h5 file trial"
...
tod = Seurat::Read10X_h5(here("GEO","Cell Ranger", "GDMPON_2_raw_feature_bc_matrix.h5")) #Change
toc = Seurat::Read10X_h5(here("GEO","Cell Ranger", "GDMPON_2_filtered_feature_bc_matrix.h5")) #Change 
sc = SoupChannel(tod,toc)

 
#Make the Seurat object from the filtered control data
SO <- Read10X_h5(here("GEO","Cell Ranger", "GDMPON_2_filtered_feature_bc_matrix.h5")) #Change
...
seurat.obj # Original: 11390
seurat.obj.f # Filtered Nuceli: 9464
...
# Determine the number of nuclei removed from filtering
seurat.obj # Original: 11390
seurat.obj.df # Filtered Nuceli: 9488
...
saveRDS(seurat.obj.df_doublets, here("Outputs", "QC Objects", "Doublet Detector Objects", "DF_GDMP_ON_2.rds")) #Change
```
...
```{r load DF object}
# seurat.obj.df_doublets <- readRDS(here("Outputs", "QC Objects", "Doublet Detector Objects", "DF_GDMP_ON_2.rds")) #Change
```
...
seurat.obj.f <- AddMetaData(object = seurat.obj.f, metadata = "GDMP_ON_2", col.name = "Replicate") #Change
...
seurat.obj.f <- AddMetaData(object = seurat.obj.f, metadata = "M26", col.name = "Animal_1") #Change
seurat.obj.f <- AddMetaData(object = seurat.obj.f, metadata = "M28", col.name = "Animal_2") #Change
...
* Cluster identification
  ...
  + 3 = Microglia
  + 4 = OPCs
  + 5 = Premyelinating Oligodendrocytes
  + 6 = Neurons
...
saveRDS(seurat.obj.f, here("Outputs", "QC Objects", "QC_GDMP_ON_2.rds")) #Change
```
