---
title: "Optic Nerve Sox10Cre+ DEG list"
...
#Creating DEG list
markers <- FindMarkers(ON_Combined, ident.1 = "Sox10 Cre+" , ident.2 = "Control", group.by = "combined.genotype", subset.ident = ON_Combined_list[i], logfc.threshold = 0.322)
...
save(list = list_objects, file = here("Outputs","DEGs", "ON Sox10 Cre+ Defining DEGs.RData"), envir = DEG.env)
...
write.xlsx(alldf, sheetName = names(alldf), file = here("Outputs","DEGs", "ON Sox10 Cre+ Defining DEGs.xlsx"))
```
