...
markers <- FindMarkers(ON_MG, ident.1 = ON_MG_list[i], logfc.threshold = 0.322, min.pct = 0.25)
...
#Creating DEG list
markers <- FindMarkers(ON_MG, ident.1 = "PLP Cre+" , ident.2 = "Sox10 Cre+", group.by = "combined.genotype", subset.ident = ON_MG_list[i], logfc.threshold = 0.322)
...
# DEGs between cluster 0 and 1
```{r echo=TRUE, warning=FALSE, error=FALSE, message=FALSE, fig.align = 'center'}

#Creating DEG list
markers <- FindMarkers(ON_MG, ident.1 = "0" , ident.2 = "1", logfc.threshold = 0.322)
...
#Save DEGs as RData
save(markers, file = here("Outputs","DEGs","Microglia Subclustering DEGs", "Subclustering Microglia Cluster 0 vs Cluster 1 DEGs.RData"))

#write excel file of DEGs
write.xlsx(markers, file = here("Outputs","DEGs","Microglia Subclustering DEGs", "Subclustering Microglia Cluster 0 vs Cluster 1 DEGs.xlsx"))
```

# DEGs between cluster 3 and 4
```{r echo=TRUE, warning=FALSE, error=FALSE, message=FALSE, fig.align = 'center'}

#Creating DEG list
markers <- FindMarkers(ON_MG, ident.1 = "3" , ident.2 = "4", logfc.threshold = 0.322)
...
#Save DEGs as RData
save(markers, file = here("Outputs","DEGs","Microglia Subclustering DEGs", "Subclustering Microglia Cluster 3 vs Cluster 4 DEGs.RData"))

#write a xlsx file of all DEG lists within an environment
write.xlsx(markers, file = here("Outputs","DEGs","Microglia Subclustering DEGs", "Subclustering Microglia Cluster 3 vs Cluster 4 DEGs.xlsx"))
```
