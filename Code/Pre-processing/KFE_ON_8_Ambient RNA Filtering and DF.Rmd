---
title: "ON_8 Ambient RNA and Doublet Removal"
...
tod = Seurat::Read10X_h5(here("GEO", "Cell Ranger", "GDMSON_8_raw_feature_bc_matrix.h5")) #Change
toc = Seurat::Read10X_h5(here("GEO", "Cell Ranger", "GDMSON_8_filtered_feature_bc_matrix.h5")) #Change 
sc = SoupChannel(tod,toc)

 
#Make the Seurat object from the filtered control data
SO <- Read10X_h5(here("GEO", "Cell Ranger", "GDMSON_8_filtered_feature_bc_matrix.h5")) #Change
...
seurat.obj # Original: 25348
seurat.obj.f # Filtered Nuceli: 7277
...
seurat.obj # Original: 25348
seurat.obj.f # Filtered Nuceli: 7277
seurat.obj.df # Filtered Nuceli: 10447
...
saveRDS(seurat.obj.df_doublets, here("Outputs", "QC Objects", "Doublet Detector Objects", "DF_GDMS_ON_8.rds")) #Change
```
...
```{r load DF object}
# seurat.obj.df_doublets <- readRDS(here("Outputs", "QC Objects", "Doublet Detector Objects", "DF_GDMS_ON_8.rds")) #Change
```
...
seurat.obj.f <- AddMetaData(object = seurat.obj.f, metadata = "GDMS_ON_8", col.name = "Replicate") #Change
...
seurat.obj.f <- AddMetaData(object = seurat.obj.f, metadata = "G15", col.name = "Animal_1") #Change
seurat.obj.f <- AddMetaData(object = seurat.obj.f, metadata = "G66", col.name = "Animal_2") #Change
...
saveRDS(seurat.obj.f, here("Outputs", "QC Objects", "QC_GDMS_ON_8.rds")) #Change
```
