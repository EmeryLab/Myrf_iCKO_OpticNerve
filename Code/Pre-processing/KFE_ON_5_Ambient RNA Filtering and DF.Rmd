---
title: "ON_5 Ambient RNA and Doublet Removal"
...
tod = Seurat::Read10X_h5(here("GEO", "Cell Ranger", "GDMPON_5_raw_feature_bc_matrix.h5")) #Change
toc = Seurat::Read10X_h5(here("GEO", "Cell Ranger", "GDMPON_5_filtered_feature_bc_matrix.h5")) #Change 
sc = SoupChannel(tod,toc)

 
#Make the Seurat object from the filtered control data
SO <- Read10X_h5(here("GEO", "Cell Ranger", "GDMPON_5_filtered_feature_bc_matrix.h5")) #Change
...
seurat.obj # Original: 22637
seurat.obj.f # Filtered Nuceli: 13124
...
# Determine the number of nuclei removed from filtering
seurat.obj # Original: 22637
seurat.obj.df # Filtered Nuceli: 13136
...
nExp_poi <- round(0.08*nrow(seurat.obj.df@meta.data)) #Change
nExp_poi
...
saveRDS(seurat.obj.df_doublets, here("Outputs", "QC Objects", "Doublet Detector Objects", "DF_GDMP_ON_5.rds")) #Change
```
...
```{r load DF object}
# seurat.obj.df_doublets <- readRDS(here("Outputs", "QC Objects", "Doublet Detector Objects", "DF_GDMP_ON_5.rds")) #Change
```
...
seurat.obj.f <- AddMetaData(object = seurat.obj.f, metadata = "GDMP_ON_5", col.name = "Replicate") #Change
...
seurat.obj.f <- AddMetaData(object = seurat.obj.f, metadata = "M32", col.name = "Animal_1") #Change
seurat.obj.f <- AddMetaData(object = seurat.obj.f, metadata = "M34", col.name = "Animal_2") #Change
...
* Cluster identification
  + 0 = Microglia -- some angry / disease state
  + 1 = Oligodendrocytes
  + 2 = Premyelinating Oligodendrocytes
  + 3 = Maybe microglia, but very low nFeature_RNA and nCount_RNA
  + 4 = OPCs
  + 5 = Astrocytes?
  + 6 = Astrocytes
  + 7 = Unknown
...
saveRDS(seurat.obj.f, here("Outputs", "QC Objects", "QC_GDMP_ON_5.rds")) #Change
