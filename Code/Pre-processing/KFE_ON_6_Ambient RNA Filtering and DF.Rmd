---
title: "ON_6 Ambient RNA and Doublet Removal"
...
tod = Seurat::Read10X_h5(here("GEO", "Cell Ranger", "GDMPON_6_raw_feature_bc_matrix.h5")) #Change
toc = Seurat::Read10X_h5(here("GEO", "Cell Ranger", "GDMPON_6_filtered_feature_bc_matrix.h5")) #Change 
sc = SoupChannel(tod,toc)

 
#Make the Seurat object from the filtered control data
SO <- Read10X_h5(here("GEO", "Cell Ranger", "GDMPON_6_filtered_feature_bc_matrix.h5")) #Change
...
seurat.obj # Original: 17830
seurat.obj.f # Filtered Nuceli: 8469
...
# Determine the number of nuclei removed from filtering
seurat.obj # Original: 17830
seurat.obj.f # "Tight filtering" Nuclei: 8469
seurat.obj.df # Filtered Nuceli: 8487
...
nExp_poi <- round(0.068*nrow(seurat.obj.df@meta.data)) #Change
nExp_poi
...
saveRDS(seurat.obj.df_doublets, here("Outputs", "QC Objects", "Doublet Detector Objects", "DF_GDMP_ON_6.rds")) #Change
```
...
```{r load DF object}
# seurat.obj.df_doublets <- readRDS(here("Outputs", "QC Objects", "Doublet Detector Objects", "DF_GDMP_ON_6.rds")) #Change
```
...
seurat.obj.f <- AddMetaData(object = seurat.obj.f, metadata = "GDMP_ON_6", col.name = "Replicate") #Change
seurat.obj.f <- AddMetaData(object = seurat.obj.f, metadata = "Male", col.name = "Sex") #Change
seurat.obj.f <- AddMetaData(object = seurat.obj.f, metadata = "PLP WT", col.name = "Genotype") #Change
seurat.obj.f <- AddMetaData(object = seurat.obj.f, metadata = "PLP", col.name = "CreType") #Change
seurat.obj.f <- AddMetaData(object = seurat.obj.f, metadata = "WT", col.name = "Cre") #Change
seurat.obj.f <- AddMetaData(object = seurat.obj.f, metadata = "Myrf", col.name = "Floxed_Gene")
seurat.obj.f <- AddMetaData(object = seurat.obj.f, metadata = "M19", col.name = "Animal_1") #Change
seurat.obj.f <- AddMetaData(object = seurat.obj.f, metadata = "M22", col.name = "Animal_2") #Change
seurat.obj.f <- AddMetaData(object = seurat.obj.f, metadata = "Day2", col.name = "Day_Nuclei_Isolated") #Change
...
* Cluster identification
  + 0 = Myelinating Oligodendrocytes
  + 1 = Astrocytes / unknown
  + 2 = Astrocytes
  + 3 = Microglia
  + 4 = OPCs
  + 5 = Myelinating Oligodendrocytes? Very low nFeatures and nCounts
  + 6 = Microglia
  + 7 = Tiny cluster
  
There appears to be some neuronal debris that isn't clustering into it's own cluster
...
saveRDS(seurat.obj.f, here("Outputs", "QC Objects", "QC_GDMP_ON_6.rds")) #Change
