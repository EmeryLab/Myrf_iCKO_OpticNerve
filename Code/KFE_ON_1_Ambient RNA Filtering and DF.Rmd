---
title: "ON_1 Ambient RNA and Doublet Removal - h5 file trial"
...
tod = Seurat::Read10X_h5(here("GEO","Cell Ranger", "GDMPON_1_raw_feature_bc_matrix.h5")) #Change
toc = Seurat::Read10X_h5(here("GEO","Cell Ranger", "GDMPON_1_filtered_feature_bc_matrix.h5")) #Change 
sc = SoupChannel(tod,toc)

#Make the Seurat object from the filtered control data
SO <- Read10X_h5(here("GEO","Cell Ranger", "GDMPON_1_filtered_feature_bc_matrix.h5")) #Change
...
seurat.obj # Original: 9743
seurat.obj.f # Filtered Nuceli: 7822
...
# Determine the number of nuclei removed from filtering
seurat.obj # Original: 9743
seurat.obj.df # Filtered Nuceli: 8312
...
# Number of cells comes from seurat.obj.df --> samples
...
saveRDS(seurat.obj.df_doublets, here("Outputs", "QC Objects", "Doublet Detector Objects", "DF_GDMP_ON_1.rds")) #Change
```
...
```{r load DF object}
# seurat.obj.df_doublets <- readRDS(here("Outputs", "QC Objects", "Doublet Detector Objects", "DF_GDMP_ON_1.rds")) #Change
```

## Subset Singlets

Note: If continuing forward with doublets removal, object `seurat.obj.f_singlets` does not exist in the downstream analysis after this code chunk. You will have to change all of the objct names to use only the nuclei deemed "singlets". 
...
seurat.obj.f <- AddMetaData(object = seurat.obj.f, metadata = "GDMP_ON_1", col.name = "Replicate") #Change
seurat.obj.f <- AddMetaData(object = seurat.obj.f, metadata = "Female", col.name = "Sex") #Change
seurat.obj.f <- AddMetaData(object = seurat.obj.f, metadata = "PLP Het", col.name = "Genotype") #Change
...
seurat.obj.f <- AddMetaData(object = seurat.obj.f, metadata = "M24", col.name = "Animal_1") #Change
seurat.obj.f <- AddMetaData(object = seurat.obj.f, metadata = "M25", col.name = "Animal_2") #Change
...
* Cluster identification
  + 0 = Microglia 
  + 1 = Oligodendrocytes
  + 2 = Premyelinating Oligodendrocytes
  + 3 = Neurons
  + 4 = Unknown
  + 5 = Neurons
  + 6 = Astrocytes
...
saveRDS(seurat.obj.f, here("Outputs", "QC Objects", "QC_GDMP_ON_1.rds")) #Change
```
